...
public class Text extends Actor
{
    ...
    private void update() {
        ...
        if( charsLeft > 0) {
            ...
            if( charsLeft > 1 && textContent.charAt(readerCharIndex) == ' ') { //look ahead for whitespace
                ...
                GreenfootImage txtImgTest = new GreenfootImage(buffer[readerLineIndex]+nextWord, fontHeight, Color.WHITE, Color.BLACK);
    ...
    private void refresh() {
       ...
       for (int i = 0; i < txtImgs.length; i++) {
           ...
           txtImgs[i] = new GreenfootImage(buffer[i], fontHeight, Color.WHITE, Color.BLACK);
